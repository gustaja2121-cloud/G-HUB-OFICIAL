  ...
  return (
    <div className="min-h-screen bg-login text-white flex flex-col items-center justify-center p-6 relative overflow-hidden font-sans" style={{ backgroundImage: "url('/login_background.png')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
      ...
      >
        ...
        <div className="premium-card p-12 text-center flex flex-col gap-6">
          <div className="space-y-3">
             <h2 className="text-2xl font-black tracking-tight uppercase">Acesso ao Hub</h2>
             <p className="text-sm font-bold text-text-dim uppercase tracking-widest leading-relaxed">
               Entre no seu <span className="text-accent">Protocolo de Alta Performance</span>
             </p>
          </div>
          ...
          <div className="space-y-3">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={loginGuest}
              className="w-full py-5 bg-accent text-white font-black uppercase tracking-[0.2em] rounded-3xl flex items-center justify-center gap-3 hover:brightness-110 transition-all shadow-2xl shadow-accent/30 active:shadow-none group cursor-pointer text-sm"
            >
              ⚡ Entrar Direto no G-HUB
            </motion.button>
            ...
            <motion.button
              ...
              className="w-full py-4 bg-white/10 text-white font-bold uppercase tracking-[0.15em] rounded-2xl flex items-center justify-center gap-3 hover:bg-white/20 transition-all text-xs cursor-pointer disabled:opacity-50"
            >
              {isLoggingIn ? (
